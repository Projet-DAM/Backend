...
import { IsEmail, IsEnum, IsNotEmpty, IsOptional, IsString, MinLength, IsArray, IsNumber, IsDateString, IsObject, IsMongoId, ValidateIf } from 'class-validator';
...
export class CreateUserDto {
  ...
  @ValidateIf(o => o.role !== UserRole.ENFANT || (o.email !== undefined && o.email !== null && o.email !== ''))
  ...
  @ValidateIf(o => o.role !== UserRole.ENFANT || (o.motDePasse !== undefined && o.motDePasse !== null && o.motDePasse !== ''))
