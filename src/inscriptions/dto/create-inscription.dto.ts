...
export class CreateInscriptionDto {
  ...
  @IsNotEmpty({ message: 'L\'ID du tournoi est requis' })
  @IsString({ message: 'L\'ID du tournoi doit être une chaîne de caractères' })
  tournoiId: string;
  ...
  @IsNotEmpty({ message: 'Le prénom de l\'enfant est requis' })
  ...
  @IsNotEmpty({ message: 'Le nom de l\'enfant est requis' })
  ...
  @IsNotEmpty({ message: 'La date de naissance de l\'enfant est requise' })
  ...
  @IsNotEmpty({ message: 'Le prénom du parent est requis' })
  ...
  @IsNotEmpty({ message: 'Le nom du parent est requis' })
  ...
  @IsNotEmpty({ message: 'Le numéro de téléphone du parent est requis' })
