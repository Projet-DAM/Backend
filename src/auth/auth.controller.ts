...
export class AuthController {
  ...
  @Public()
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Tester l\'envoi d\'email (endpoint de debug)' })
  @ApiResponse({
    status: 200,
    description: 'Email de test envoyé',
  })
  async testEmail(@Body() body: { email: string; nom?: string; prenom?: string }) {
    return this.authService.testEmail(body.email, body.nom || 'Test', body.prenom || 'User');
  }
}
