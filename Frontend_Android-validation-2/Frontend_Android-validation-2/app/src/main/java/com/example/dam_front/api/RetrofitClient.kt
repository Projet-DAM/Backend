...
object RetrofitClient {
    ...
    private val gson: Gson = GsonBuilder()
        .setLenient()
        .serializeNulls()
        .registerTypeAdapter(com.example.dam_front.models.ParentSummary::class.java, com.example.dam_front.models.ParentSummaryDeserializer())
        .registerTypeAdapter(com.example.dam_front.models.ProgramSummary::class.java, com.example.dam_front.models.ProgramSummaryDeserializer())
        .registerTypeAdapter(com.example.dam_front.models.ChildSummary::class.java, com.example.dam_front.models.ChildSummaryDeserializer())
        .registerTypeAdapter(com.example.dam_front.data.EnfantRef::class.java, com.example.dam_front.data.EnfantRefDeserializer())
        .create()
